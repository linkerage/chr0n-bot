...
class IRCBot:
    ...
    def handle_command(self, parsed_msg):
        ...
        # Bot commands
        if command == "help":
            self.send_message(channel, f"{nick}: Available commands: !help, !ping, !about, !uptime, !gentoo, !churchbong, !toke, !pass, !joint, !dab, !blunt, !blaze")
        ...
        elif command in ["toke", "pass", "joint", "dab", "blunt"]:
